 ...
 */
class GpsLocation extends \GeoStory\Entity\GpsLocation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'GeoStory\\Entity\\GpsLocation' . "\0" . 'story', '' . "\0" . 'GeoStory\\Entity\\GpsLocation' . "\0" . 'longitude', '' . "\0" . 'GeoStory\\Entity\\GpsLocation' . "\0" . 'latitude');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GpsLocation $proxy) {
